...
public class signupfeaturesteps {
    @Given("you are in signup page to sign up")
    public void you_are_in_signup_page_to_sign_up() {
        // Write code here that turns the phrase above into concrete actions
        //throw new io.cucumber.java.PendingException();
    }

    @When("you write the {string}, {string}, {string}, {string}, {string}, {string}, {string} and {string} and {string}")
    public void you_write_the_and_and(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9) {
        // Write code here that turns the phrase above into concrete actions
        //throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("you are in signup page weak pass")
    public void you_are_in_signup_page_weak_pass() {
        // Write code here that turns the phrase above into concrete actions
        // throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("you are in signup page Successfully")
    public void you_are_in_signup_page_successfully() {
        // Write code here that turns the phrase above into concrete actions
        //throw new io.cucumber.java.PendingException();
    }
