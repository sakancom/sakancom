...
#    And the owner want to update house with id -1
#    When the owner want to update the rent of the House to be 1500.0
...
#    And the owner want to update house with id equal -1
...
#    And there is a House the owner want to update  with id  -1
