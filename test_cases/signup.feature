Feature: SignUp
  ...
  Scenario Outline: duplicate id
    ...
    Examples:
      | id  | name  | PhoneNumber | address     | city     | street | email                | password |
      | 111 | Alaa  | 0594160463  | building 22 | Nablus   | jalood | alaahas345@gmail.com | 123456   |
  ...
  Scenario Outline: weak password
    ...
    Examples:
      | id  | name  | PhoneNumber | address     | city     | street | email                | password |
      | 111 | Alaa  | 0594160463  | building 22 | Nablus   | jalood | alaahas345@gmail.com | 123      |
